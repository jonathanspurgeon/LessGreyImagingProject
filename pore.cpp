...
std::vector<pore *> & pore::getNeighboors()
{
    return neighboors;
}
...
std::map<int, double> &pore::getFeedingVessels()
{
    return feedingVessels;
}

double pore::getInflowShare() const
{
    return inflowShare;
}

void pore::setInflowShare(double value)
{
    inflowShare = value;
}

bool pore::getVisited() const
{
    return visited;
}

void pore::setVisited(bool value)
{
    visited = value;
}
double pore::getAveragePressure() const
{
    return averagePressure;
}

void pore::setAveragePressure(double value)
{
    averagePressure = value;
}
double pore::getWSS() const
{
    return WSS;
}

void pore::setWSS(double value)
{
    WSS = value;
}
bool pore::getParentVessel() const
{
    return parentVessel;
}

void pore::setParentVessel(bool value)
{
    parentVessel = value;
}
double pore::getFQE() const
{
    return FQE;
}

void pore::setFQE(double value)
{
    FQE = value;
}

double pore::getConvectedStim() const
{
    return convectedStim;
}

void pore::setConvectedStim(double value)
{
    convectedStim = value;
}

double pore::getConductedStim() const
{
    return conductedStim;
}

void pore::setConductedStim(double value)
{
    conductedStim = value;
}
