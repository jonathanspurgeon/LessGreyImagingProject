...
double element::getVesselType() const
{
    return vesselType;
}

void element::setVesselType(double value)
{
    vesselType = value;
}
...
double element::getRadius_sq() const
{
    return radius_sq;
}

void element::setRadius_sq(double value)
{
    radius_sq = value;
}
double element::getLength_sq() const
{
    return length_sq;
}

void element::setLength_sq(double value)
{
    length_sq = value;
}

double element::getHDConcentration() const
{
    return HDConcentration;
}

void element::setHDConcentration(double value)
{
    HDConcentration = value;
}

double element::getMembranePermeability() const
{
