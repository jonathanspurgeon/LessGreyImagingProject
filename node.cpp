...
bool node::getSprouTip() const
{
    return sprouTip;
}

void node::setSprouTip(bool value)
{
    sprouTip = value;
}
...
int node::getFeedingVesselsNumber() const
{
    return feedingVesselsNumber;
}

void node::setFeedingVesselsNumber(int value)
{
    feedingVesselsNumber = value;
}
